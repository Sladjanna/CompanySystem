...
namespace UI.Admin
{
    ...
    private void LoadAllDepartments()
        {
            ...
            //    {
            //        department_cmb.Items.Add(item.NameOfDepartment);
            //    }
        ...
        public void LoadAllUsers()
        {
            ...
            //{
            //    if (item.DepartmentID.Name == selectedDepartment)
            //        tempList.Add(item);
        ...
        public void LoadAdministrators()
        {
            ...
            //    administratorsList = UserServices.GetAllAdministrators();

            //    List<User> tempList = new List<User>();

            //    foreach (User item in administratorsList)
            //    {
            //        if (item.DepartmentID.NameOfDepartment == selectedDepartment)
            //            tempList.Add(item);
            //        if (selectedDepartment == "")
            //            tempList.Add(item);
            //    }
        ...
        public void LoadManagers()
        {
            ...
            //    managersList = UserServices.GetAllManagers();
        ...
        public void LoadEmployees()
        {
            ...
            //    employeesList = UserServices.GetAllEmployees();
   ...
   //     }
        ...
        private void department_cmb_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            //    dep.NameOfDepartment = pickedDepartment;
            //    selectedDepartment = dep.NameOfDepartment.ToString();  // naziv departmana
